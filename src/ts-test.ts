...
function connectWithProtocol(host: string, protocol: 'http' | 'https'): void {
  // ...
}
...
function objMod(obj: { left: number }): void {
  // ...
}
...
function printCarInfo(m: Model): void {
...
function printInfo(m: Model): void {
